...
import com.zmsoft.widget.listener.IDragableGridView;
...
public class DragableGridView extends GridView {
    ...
    private IDragableGridView dragableGridView;
    private OnItemLongClickListener onLongClickListener = new OnItemLongClickListener() {
        ...
        public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            //设置被长按item不显示
            //((com.zmsoft.eatery.cashdesk.setting.adapter.HomeCommonUseAdapter)getAdapter()).hideView(position);
            return true;
        }
    };
        ...
        //dragImageView处于被拖动时，更新dragImageView位置
            ...
            if ((currDraggedPosition != AdapterView.INVALID_POSITION) && (currDraggedPosition != preDraggedOverPositon)) {
                if (dragableGridView != null) {
                    dragableGridView.swapView(preDraggedOverPositon, currDraggedPosition);
                }
    ...
    public void setDragableGridView(IDragableGridView dragableGridView) {
        this.dragableGridView = dragableGridView;
    }
}