...
public class WheelView extends View {
    ...
    private boolean renderWheelBg, renderWheelVal, renderTopBg, renderItemColor, renderValueColor;
    ...
    private void initData(Context context) {
        ...
        renderWheelBg = false;
        renderWheelVal = false;
        renderTopBg = false;
        renderItemColor = false;
        renderValueColor = false;
    }
    ...
    private void initResourcesIfNecessary() {
        ...
        if (renderWheelVal) {
            centerDrawable = getContext().getResources().getDrawable(wheelVal);
        } else {
    ...
    private int getItemHeight() {
        return getContext().getResources().getDimensionPixelSize(R.dimen.px44);
        //return 44;
        // if (itemHeight != 0) {
        // return itemHeight;
    ...
    private void drawValue(Canvas canvas) {
        if (renderValueColor) {
            valuePaint.setColor(value_txt_color);
        } else {
    ...
    private void drawItems(Canvas canvas) {
        ...
        if (renderItemColor) {
            itemsPaint.setColor(item_text_color);
        } else {
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        centerDrawable.setBounds(0, center - offset, getWidth(), center + 2 * offset - 25);
    ...
    public void setWheelBg(int wheelBg) {
        this.renderWheelBg = true;
        this.wheelBg = wheelBg;
    }

    public void setWheelVal(int wheelVal) {
        this.renderWheelVal = true;
        this.wheelVal = wheelVal;
    }

    public void setShadows_colors(int[] shadows_colors) {
        this.renderTopBg = true;
        this.shadows_colors = shadows_colors;
    }

    public void setItem_text_color(int item_text_color) {
        this.renderItemColor = true;
        this.item_text_color = item_text_color;
    }

    public void setValue_txt_color(int value_txt_color) {
        this.renderValueColor = true;
        this.value_txt_color = value_txt_color;
    }
}
