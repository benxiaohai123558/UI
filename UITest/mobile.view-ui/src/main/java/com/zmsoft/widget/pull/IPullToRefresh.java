...
import com.zmsoft.widget.pull.PullToRefreshBaseNew.OnPullEventListener;
import com.zmsoft.widget.pull.PullToRefreshBaseNew.OnRefreshListener;
import com.zmsoft.widget.pull.PullToRefreshBaseNew.State;
...
public interface IPullToRefresh<T extends View> {
	 ...
	 * @param listener - Listener to be used when the Widget is set to Refresh
	 */
	public void setOnRefreshListener(PullToRefreshBaseNew.OnRefreshListener2<T> listener);
